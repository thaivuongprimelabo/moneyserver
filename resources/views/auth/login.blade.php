                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{url('/checklogin')}}">
                        ...
                        <div class="form-group{{ $errors->has('loginid') ? ' has-error' : '' }}">
                            <label for="loginid" class="col-md-4 control-label">E-Mail Address</label>

                            <div class="col-md-6">
                                <input id="loginid" type="text" class="form-control" name="loginid" value="{{ old('loginid') }}" required autofocus>
